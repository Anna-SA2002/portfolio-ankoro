import{n as e,t}from"./cake-sketch-CgRR3JQ7.js";var n=e((()=>{var e=document.querySelector(`#work-detail`),t={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#039;`};function n(e){return String(e??``).replace(/[&<>"']/g,e=>t[e])}function r(e){return`/portfolio-ankoro/${String(e??``).replace(/^\/+/,``)}`}function i(e){return`/portfolio-ankoro/${String(e??``).replace(/^\/+/,``)}`}function a(t){e.innerHTML=`
